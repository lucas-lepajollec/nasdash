...
export default defineWidget({
  type: 'docker-summary', group: 'docker', icon: '📊',
  nameKey: 'widget.dockerSummary.name', descriptionKey: 'widget.dockerSummary.description',
  ...
  sizes: { formats: [4, 6, 8, 12, 24], default: 6, minPx: 150, h: 80 },
});
