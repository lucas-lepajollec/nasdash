  ...
  return (
    <>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {/* En-tête Mobile */}
        <SettingsAccordion
          title="Disposition de l'En-tête Mobile"
          description="Gérez la position des éléments en haut de l'écran"
          icon={<Layers size={18} />}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div className="nd-settings-card" style={{ padding: '14px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--nd-card-border)', borderRadius: 'var(--nd-card-radius)' }}>
              ...
              <p style={{ margin: '4px 0 16px 0', fontSize: '0.7rem', color: 'var(--nd-text-muted)' }}>
                Activez/désactivez les éléments et utilisez les flèches pour définir leur ordre de gauche à droite. L'élément Menu est toujours épinglé à droite.
              </p>
                    ...
                    <div key={item} style={{ display: 'flex', flexDirection: 'column', padding: '14px', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--nd-card-border)', borderRadius: 'var(--nd-card-radius)' }}>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
                        ...
                        <div style={{ display: 'flex', gap: 6, alignItems: 'center', opacity: !isHidden ? 1 : 0.5, transition: 'opacity 0.2s', flexWrap: 'wrap' }}>
                          ...
                          <button onClick={() => moveItem(i, 1)} disabled={i === 1} style={{ padding: '6px 10px', background: 'var(--nd-bg-alt)', border: '1px solid var(--nd-card-border)', borderRadius: '6px', cursor: i === 1 ? 'not-allowed' : 'pointer', color: i === 1 ? 'var(--nd-text-muted)' : 'var(--nd-text)', opacity: i === 1 ? 0.3 : 1, display: 'flex', alignItems: 'center', gap: 4, fontSize: '0.75rem', fontWeight: 600, whiteSpace: 'nowrap' }} title="Descendre">
                            Descendre ↓
                          </button>
                        </div>
                      </div>
            ...
            <p style={{ margin: '0', fontSize: '0.7rem', color: 'var(--nd-text-muted)' }}>
              Le bouton du menu principal reste toujours accessible à droite de l'écran.
            </p>
          </div>
        </SettingsAccordion>
        ...
        <SettingsAccordion
          title="Apparence Spéciale Mobile"
          description="Surchargez les paramètres globaux (thème, fond, géométrie)"
