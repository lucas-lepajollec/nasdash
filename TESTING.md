...
- keyboard accessibility of the dashboard and settings dialog, including names, focus trapping, Escape, focus restoration and rendering of the General and Weather settings pages;
